    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //Email.Signup(Common.EmailType.Signup, user.Email, callbackUrl);

                    //return RedirectToAction("Index", "Main");
                    Session["student"] = student;
                    return RedirectToAction("Create", "StudentCareers");
                }
                AddErrors(result);
            }
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                Email.ForgotPassword(Common.EmailType.ForgotPassword, user.Email, callbackUrl, user.Name + " " +user.LastName);
        ...
        {
            var users = db.Users.Where(u => u.EmailConfirmed == false);
            //var users = db.AspNetUser.Where(u => u.EmailConfirmed == false);
            return View(users.ToList());
        }

        [HttpGet]
        [Authorize(Roles = "Admin")]
        public ActionResult SendUserConfirmation(string id)
        {
            if (id == null)
            {
        ...
        [Authorize(Roles = "Admin")]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> SendUserConfirmation(AspNetUser model)
        {//[Bind(Include = "CareerId,CareerName,Status,QuestionsInExam,MinScore")]
            if (ModelState.IsValid)
            {
        ...
        //{
        //    var role = db.Roles.SingleOrDefault(m => m.Name == "Student");
